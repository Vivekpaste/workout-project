...
with open('/Users/shaunpereira/Desktop/yeshu/github/workout-project/backend/subprocess/chestfly.pkl','rb') as f:
    model=pickle.load(f)
...
# Recolor Feed
        ...
        try:
            ...
            if body_language_class == 'close' and body_language_prob[body_language_prob.argmax()]>=0.55: 
                current_stage = 'close'
            elif current_stage =='close' and body_language_class =='stretch' and body_language_prob[body_language_prob.argmax()]>0.55:
                current_stage="stretch"
                counter =counter+1
